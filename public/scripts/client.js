...
const resetErrorMessage = validation => {
  if (validation === "over count") {
    $(".error-message").hide();
    $(".error-message").empty();
    $(".error-message").append("<p>Tweet is too long!</p>");
    $(".error-message").slideDown("slow");
    $('textarea').focus();
  } else if (validation === "empty") {
    $(".error-message").hide();
    $(".error-message").empty();
    $(".error-message").append("<p>Enter Text...</p>");
    $(".error-message").slideDown("slow");
    $('textarea').focus();
  } else {
    $(".error-message").hide();
